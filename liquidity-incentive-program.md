...
7.5% of the initial token supply of RabbitX (75,000,000 RBX) will be distributed to liquidity providers based on the $$Q_{FINAL}$$ measuring the liquidity provider's width, depth and uptime per 30-day epoch.
...
| Month    | Rewards per month (RHS) | Cumulative Rewards (LHS) | % supply |
| -------- | ----------------------- | ------------------------ | -------- |
